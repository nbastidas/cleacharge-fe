...
gulp.task('html', ['inject', 'partials'], function () {
  ...
  var appJsFilter = $.filter(path.join(conf.paths.src, '/app/**/*.js'), { restore: true });
  var jsFilter = $.filter(['**/*.js', '!' + path.join(conf.paths.src, '/app/**/*.js')], { restore: true });
...
gulp.task(
  ...
  function () {
    return gulp.src([
        path.join(conf.paths.src, '/fonts/**/*.ttf')
       ])
...
gulp.task('build', ['html', 'other', 'tinymce']);
